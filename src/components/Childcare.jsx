  ...
  return (
    <div className="container mx-auto p-4 shadow-lg rounded-md bg-white">
      ...
      <div>
        ...
        <p>
          I really enjoy looking after children and I have a lot of energy and am reliable and organized. I think it's
          important to develop a good relationship with the children's parents and become part of the family. I am
          available Monday to Friday 7:45-6:45 and weekends.
        </p>
      </div>
